      ...
      <div className="flex sm:flex-1 sm:items-center sm:justify-between w-full">
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-4 sm:mb-0 w-full sm:w-auto">
          ...
          <select
            ...
            className="block w-32 rounded-lg border-0 py-1.5 pl-3 pr-8 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-blue-500 sm:text-sm sm:leading-6 bg-slate-50 hover:bg-white cursor-pointer"
          >
